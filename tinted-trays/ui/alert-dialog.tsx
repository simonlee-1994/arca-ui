...
import { buttonVariants } from "@/components/themes/tinted-trays/button"
  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        ...
        className={cn(
          [
            "bg-tray fixed top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-6 px-8 py-7 sm:max-w-lg",
