...
const chartContainerVariants = cva(
  [
    ...
    "[&_.recharts-curve.recharts-tooltip-cursor]:stroke-primary/30",
  ...
  ],
  {
    variants: {
      ...
      rim: {
        ...
        none: "rounded-none border-0 shadow-none",
      },
      padding: {
        default: "p-6",
        sm: "p-4",
  ...
  return (
    <ChartContext.Provider value={{ config }}>
      <div
        ...
        data-chart={chartId}
        className={cn(
          chartContainerVariants({ surface, rim, padding }),
          className
        )}
        {...props}
      >
...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        "bg-background grid min-w-[8rem] items-start gap-1.5 rounded-xl border border-border/60 px-3 py-2 text-xs",
        "shadow-[0_10px_30px_rgba(15,23,42,0.14),inset_0_1px_0_rgba(255,255,255,0.85)]",
        className
      )}
    >
