...
const carouselViewportVariants = cva(
  ["overflow-hidden"],
  {
    variants: {
      ...
      rim: {
        strong: [
          "p-4 rounded-3xl border border-border/40",
          "shadow-[inset_0_1px_0_rgba(255,255,255,0.85),inset_0_2px_10px_rgba(15,23,42,0.06)]",
        ],
        default: [
        ...
        none: "p-0 rounded-none border-0 shadow-none",
      },
    },
    defaultVariants: {
      surface: "tray",
...
function CarouselContent({
  ...
  return (
    <div
      ref={carouselRef}
      className={cn(
        carouselViewportVariants({ surface, rim }),
        viewportClassName
      )}
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        "hover:bg-secondary/80 hover:shadow-[0_2px_6px_rgba(15,23,42,0.10)]",
        "disabled:opacity-50",
