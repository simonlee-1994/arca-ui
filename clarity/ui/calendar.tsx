...
import { Button, buttonVariants } from "@/components/themes/clarity/button"
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_root: cn(
          "relative has-focus:border-ring border border-input radius-control has-focus:ring-ring/20 has-focus:ring-[3px] bg-background",
          defaultClassNames.dropdown_root
        ),
        dropdown: cn(
          "absolute inset-0 opacity-0 cursor-pointer appearance-none w-full h-full",
        ...
        caption_label: cn(
          ...
          captionLayout === "label"
            ? "text-sm"
            : "radius-control pl-2 pr-1 flex items-center gap-1 text-sm h-8 [&>svg]:text-muted-foreground [&>svg]:size-3.5",
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        modifiers.today && !modifiers.selected ? "ring-1 ring-border ring-inset" : "",
        "group-data-[focused=true]/day:border-ring group-data-[focused=true]/day:ring-ring/20",
